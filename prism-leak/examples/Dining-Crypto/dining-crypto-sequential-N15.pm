...
global coin15 : [0..2]; // coin value of crypt15
...
global observable agree15 : [0..1]; // declaration of crypt15
...
module crypt
	...
	// flip coins
	[] s1=-15 & coin1=0 -> pr : (coin1'=1) & (s1'=-14) + 1.0-pr : (coin1'=2) & (s1'=-14);
    [] s1=-14 & coin2=0 -> pr : (coin2'=1) & (s1'=-13) + 1.0-pr : (coin2'=2) & (s1'=-13);
    [] s1=-13 & coin3=0 -> pr : (coin3'=1) & (s1'=-12) + 1.0-pr : (coin3'=2) & (s1'=-12);
    [] s1=-12 & coin4=0 -> pr : (coin4'=1) & (s1'=-11) + 1.0-pr : (coin4'=2) & (s1'=-11);
    [] s1=-11 & coin5=0 -> pr : (coin5'=1) & (s1'=-10) + 1.0-pr : (coin5'=2) & (s1'=-10);
    [] s1=-10 & coin6=0 -> pr : (coin6'=1) & (s1'=-9) + 1.0-pr : (coin6'=2) & (s1'=-9);
    [] s1=-9 & coin7=0 -> pr : (coin7'=1) & (s1'=-8) + 1.0-pr : (coin7'=2) & (s1'=-8);
	[] s1=-8 & coin8=0 -> pr : (coin8'=1) & (s1'=-7) + 1.0-pr : (coin8'=2) & (s1'=-7);
	[] s1=-7 & coin9=0 -> pr : (coin9'=1) & (s1'=-6) + 1.0-pr : (coin9'=2) & (s1'=-6);
	[] s1=-6 & coin10=0 -> pr : (coin10'=1) & (s1'=-5) + 1.0-pr : (coin10'=2) & (s1'=-5);
	[] s1=-5 & coin11=0 -> pr : (coin11'=1) & (s1'=-4) + 1.0-pr : (coin11'=2) & (s1'=-4);
	[] s1=-4 & coin12=0 -> pr : (coin12'=1) & (s1'=-3) + 1.0-pr : (coin12'=2) & (s1'=-3);
	[] s1=-3 & coin13=0 -> pr : (coin13'=1) & (s1'=-2) + 1.0-pr : (coin13'=2) & (s1'=-2);
	[] s1=-2 & coin14=0 -> pr : (coin14'=1) & (s1'=-1) + 1.0-pr : (coin14'=2) & (s1'=-1);
	[] s1=-1 & coin15=0 -> pr : (coin15'=1) & (s1'=0) + 1.0-pr : (coin15'=2) & (s1'=0);
	...
	[] s1=13 & coin14>0 & coin15>0 & coin14=coin15    & (pay!=p14) -> (s1'=14) & (agree14'=1);
	[] s1=13 & coin14>0 & coin15>0 & !(coin14=coin15) & (pay!=p14) -> (s1'=14);
	[] s1=13 & coin14>0 & coin15>0 & coin14=coin15    & (pay=p14)  -> (s1'=14);
	[] s1=13 & coin14>0 & coin15>0 & !(coin14=coin15) & (pay=p14)  -> (s1'=14) & (agree14'=1);

	[] s1=14 & coin15>0 & coin1>0 & coin15=coin1    & (pay!=p15) -> (s1'=15) & (agree15'=1);
	[] s1=14 & coin15>0 & coin1>0 & !(coin15=coin1) & (pay!=p15) -> (s1'=15);
	[] s1=14 & coin15>0 & coin1>0 & coin15=coin1    & (pay=p15)  -> (s1'=15);
	[] s1=14 & coin15>0 & coin1>0 & !(coin15=coin1) & (pay=p15)  -> (s1'=15) & (agree15'=1);
...
init   
	s1=-N & coin1=0&agree1=0 & coin2=0&agree2=0 & coin3=0&agree3=0 & coin4=0&agree4=0 
		  ...
		  & coin13=0&agree13=0 & coin14=0&agree14=0 & coin15=0&agree15=0
endinit
