...
module student1	
	...
	[] s1=-4 -> pr:(num4'=0)&(s1'=-3) + pr:(num4'=1)&(s1'=-3) + pr:(num4'=4)&(s1'=-3) + 
						pr:(num4'=2)&(s1'=-3) + 1.0-(n-1)*pr:(num4'=3)&(s1'=-3);
	[] s1=-3 -> pr:(num1'=0)&(s1'=-2) + pr:(num1'=1)&(s1'=-2) + pr:(num1'=4)&(s1'=-2) + 
						pr:(num1'=2)&(s1'=-2) + 1.0-(n-1)*pr:(num1'=3)&(s1'=-2);
	[] s1=-2 -> pr:(num2'=0)&(s1'=-1) + pr:(num2'=1)&(s1'=-1) + pr:(num2'=4)&(s1'=-1) + 
						pr:(num2'=2)&(s1'=-1) + 1.0-(n-1)*pr:(num2'=3)&(s1'=-1);
	[] s1=-1 -> pr:(num3'=0)&(s1'=0) + pr:(num3'=1)&(s1'=0) + pr:(num3'=4)&(s1'=0) + 
						pr:(num3'=2)&(s1'=0) + 1.0-(n-1)*pr:(num3'=3)&(s1'=0);
    ...
    [] s1=3 -> (ann4'=mod(h4+num4-num1,n)) & (s1'=4);
...
init  s1=-4 & sum=0 & ann1=0&ann2=0&ann3=0&ann4=0 & num1=-1&num2=-1&num3=-1&num4=-1 endinit
