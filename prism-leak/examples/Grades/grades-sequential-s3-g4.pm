...
module student1	
    ...
    // compute sum
    [] s1=3 -> (sum'=mod(sum+ann1,n)) & (s1'=4);
    [] s1=4 -> (sum'=mod(sum+ann2,n)) & (s1'=5);
    [] s1=5 -> (sum'=mod(sum+ann3,n)) & (s1'=6);

endmodule

// set of initial states
init  s1=-3 & sum=0 & ann1=0&ann2=0&ann3=0 & num1=-1&num2=-1&num3=-1 endinit
