...
global s7 : [0..1];
global secret vot7 : [1..c]; 
global s8 : [0..1];
global secret vot8 : [1..c]; 
global s9 : [0..1];
global secret vot9 : [1..c]; 
...
module voter7 = voter1 [ vot1=vot7, s1=s7 ] endmodule
module voter8 = voter1 [ vot1=vot8, s1=s8 ] endmodule
module voter9 = voter1 [ vot1=vot9, s1=s9 ] endmodule

// set of initial states
// (voters in their initial state, "vot1, ..., voteN" can be anything)
init  s1=0 & s2=0 & s3=0 & s4=0 & s5=0 & s6=0 & s7=0 & s8=0 & s9=0 & result1=0&result2=0 endinit
