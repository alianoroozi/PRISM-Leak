...
global observable result5 : [0..N];
global observable result6 : [0..N];
global observable result7 : [0..N];
global observable result8 : [0..N];
...
module voter1	
    ...
    //voter1 voted to candidate 5
    [] s1=0 & vot1 = 5 & result5<N -> (result5'=result5+1) & (s1'=1);
    //voter1 voted to candidate 6
    [] s1=0 & vot1 = 6 & result6<N -> (result6'=result6+1) & (s1'=1);
    //voter1 voted to candidate 7
    [] s1=0 & vot1 = 7 & result7<N -> (result7'=result7+1) & (s1'=1);
    //voter1 voted to candidate 8
    [] s1=0 & vot1 = 8 & result8<N -> (result8'=result8+1) & (s1'=1);
...
module voter6 = voter1 [ vot1=vot6, s1=s6 ] endmodule

// set of initial states
// (voters in their initial state, "vot1, ..., voteN" can be anything)
init  s1=0 & s2=0 & s3=0 & s4=0 & s5=0 & s6=0 & result1=0&result2=0&result3=0&result4=0&result5=0&result6=0&result7=0&result8=0 endinit
