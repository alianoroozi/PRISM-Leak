...
const int n = 4; // num of bits of the pin variable
...
module Gamma
    ...
    [] turn=3 & c3=3 & maintrigger!=2 & c4=1 -> (turn'=2);
    [] turn=3 & c3=3 & maintrigger!=2 & c4=1 -> (turn'=1);
    [] turn=3 & c3=3 & maintrigger!=2 & c4=0 -> (turn'=4);
    [] turn=3 & c3=4 -> (mask'=floor(mask/2)) & (c3'=0);
    [] turn=3 & c3=5 -> (trigger0'=1) & (c3'=6);
    [] turn=3 & c3=6 -> (trigger1'=1) & (c3'=7);
endmodule

module Delta
    [] turn=4 & c4=0 -> (result'=pin) & (c4'=1);
    [] turn=4 & c4=1 -> (result'=0) & (c4'=2) & (turn'=3);

endmodule

init
    mask=2 & result=0 & maintrigger=0 & trigger0=0 & 
    trigger1=0 & c1=0 & c2=0 & c3=0 & c4=0 & turn=3
endinit
